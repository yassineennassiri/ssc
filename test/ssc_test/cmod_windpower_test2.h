#ifndef __WINDPOWER_TEST2__
#define __WINDPOWER_TEST2__
...
/*	SSC Var Name							Data Type			Test Values				Length,Width */
	{"wind_resource_filename",				STR,				filepath							},
...
/*	SSC Var Name							Test Type			Test Result				Error Bound % */
	...
	{"monthly_energy[12]",					NR,					2.8218e6,				.1}
};

SimulationTestTable windpowerTestDefault("cmod_windpower", &windpowerDefaultInfo[0], 18, &windpowerDefaultResult[0], 3);
