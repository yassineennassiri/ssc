...
static var_info _cm_vtab_pv_get_single_shade_loss[] = {
...
class cm_pv_get_single_shade_loss : public compute_module
{
public:

	cm_pv_get_single_shade_loss()
	{
		add_var_info(_cm_vtab_pv_get_single_shade_loss);
	}
...
DEFINE_MODULE_ENTRY(pv_get_single_shade_loss, "PV get shade loss fraction for strings from Sara MacAlpine", 1)
